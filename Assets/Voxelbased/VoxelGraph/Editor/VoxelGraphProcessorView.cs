...
{
    public class VoxelGraphProcessorView : PinnedElementView
    {
        VoxelGraphProcessor processor;
        BaseGraphView graphView;

        public VoxelGraphProcessorView() => title = "Voxel Graph Processor";

        protected override void Initialize(BaseGraphView graphView)
        {
            processor = new VoxelGraphProcessor(graphView.graph);
